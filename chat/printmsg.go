...
/*
  Essentially equivalent to echo.go server.

  The only difference is incoming messages
  are printed on server's console.
*/
...
func printMessages(msgchan <-chan string) {
	for {
		msg := <-msgchan // block until next message received
